...
public class Feedback {
    ...
    public String getProductName() {  // �?ổi từ getGetProductName thành getProductName
        return getProductName;
    }

    public void setProductName(String productName) {  // �?ổi từ setGetProductName thành setProductName
