...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        var discount = 0.00; // Bi?n toàn c?c l?u gi?m giá
        var shippingFee = 40.00; // Phí v?n chuy?n c? ??nh
        ...
        function updateTotal() {
            ...
            // C?p nh?t input hidden ?? g?i lên server
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === "error") {
                        ...
                        discount = response.discount; // C?p nh?t gi?m giá
                        document.getElementById("discount").textContent = "$" + response.discount.toFixed(2);
                        document.getElementById("hiddenVoucher").value = voucherCode; // L?u mã voucher
                    }
        ...
        // N?u có mã voucher trên URL, t? ??ng ?i?n vào input
