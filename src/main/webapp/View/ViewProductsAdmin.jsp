                        ...
                        <tbody>
                            <c:forEach var="product" items="${listProduct}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<c:url value="ManageProduct?id=${product.productID}&action=edit"/>" class="btn btn-primary btn-sm">Edit</a>
                                        <a href="<c:url value="ManageProduct?id=${product.productID}&action=inventory"/>" class="btn btn-primary btn-sm">Inventory</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
