        ...
        <div class="order-container">
            ...
            <div class="product">
                ...
                <div class="product-details">
                    ...
                    Unit Price: <fmt:formatNumber value="<%= detail.getUnitPrice() %>" pattern="#,###" /> </span>₫
                </div>
                <div class="price"> <fmt:formatNumber value="<%= detail.getUnitPrice() * detail.getQuantity() %>" pattern="#,###" />  </span>₫ </div> 
            </div>
            <% }%>
            <%
            ...
            <div class="summary">
                ...
                <p>Subtotal: <strong><fmt:formatNumber value="<%= orderDetails.get(0).getTotalAmount() %>" pattern="#,###" /> </strong>₫</p>
                <p>Voucher Discount: <strong><fmt:formatNumber value="<%= orderDetails.get(0).getDiscountAmount()%>" pattern="#,###" /> </strong>₫</p>
                <p>Total: <strong><fmt:formatNumber value="<%= orderDetails.get(0).getFinalAmount()%>" pattern="#,###" /> </strong>₫</p>
            </div>
